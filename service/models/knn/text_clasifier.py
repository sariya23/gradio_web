...
MODEL_KNN = joblib.load(os.path.join("models", "knn", "model", "model_knn.pkl"))
VECTORIZER = joblib.load(os.path.join("models", "knn", "model", "vectorizer.pkl"))
FOLDER_NAMES_LIST = joblib.load(os.path.join("models", "knn", "meta_data", "folders_names_list.pkl"))
STOP_WORDS_LIST = joblib.load(os.path.join("models", "knn", "meta_data", "stop_words_list.pkl"))
